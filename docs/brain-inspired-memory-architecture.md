# Agent Passport 类脑启发式记忆架构

## 核心结论

Agent Passport 不去机械复制人脑，而是借鉴人脑更有效的运行顺序：
...
`OpenNeed 负责发生，Agent Passport 负责记住，并把事件慢慢变成可复用的抽象经验。`
