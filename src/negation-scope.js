...
const QUANTIFIER_PATTERNS = [
  ...
  /(不是|并非)\s*(所有|全部)(?:当前记忆|记忆焦点|目标上下文|流程|匹配结果)?/u,
  /(所有|全部)(?:当前记忆|记忆焦点|目标上下文|流程|匹配结果)?/u,
  /(大多数|多数|部分|少数)(?:当前记忆|记忆焦点|目标上下文|流程|匹配结果)?/u,
  /(至少(?:\d+项?|一项|两项|三项)|至多(?:\d+项?|一项|两项|三项)|仅(?:\d+项?|一项|两项|三项)|只有(?:\d+项?|一项|两项|三项))(?:当前记忆|记忆焦点|目标上下文|流程|匹配结果)?/u,
  /(其中一项|另一项|前者|后者)/u,
  /(一半)(?:当前记忆|记忆焦点|目标上下文|流程|匹配结果)?/u,
];
...
function classifyQuantifierFamily(cue = "") {
  ...
  if (/其中一项|另一项|前者|后者/u.test(normalized)) {
