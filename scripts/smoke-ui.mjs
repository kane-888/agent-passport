...
async function main() {
  ...
  includesAll(
    ...
    [
      ...
      "auto-recovery-audit-filter",
      "auto-recovery-audit-list",
      "auto-recovery-audit-detail-summary",
      "auto-recovery-audit-json",
      "download-auto-recovery-audit-evidence",
      "setup-summary",
